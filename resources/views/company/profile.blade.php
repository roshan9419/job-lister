        ...
        <div class="col-lg-4">
          <div class="card mb-4">
            <div class="card-body text-center">
              <img src="{{ asset('storage/images/companies/'.$company->name_slug.'.jpg') }}" alt="avatar" class="img-fluid" style="width: 150px">
            ...
            <div class="card-body p-0">
              <ul class="list-group list-group-flush rounded-3">
                <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                  ...
                  <a class="mb-0" href="{{$company->website}}" style="text-decoration: none">{{$company->website}}</a>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center p-3">
          ...
          <div class="card mb-4">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-9">
                  <p class="text-muted mb-0">{{$company->state}}, {{$company->country}}</p>
                </div>
              </div>
            </div>
          </div>
