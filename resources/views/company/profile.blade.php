    ...
    <div class="bg-white shadow rounded overflow-hidden">
      <div class="px-4 pt-0 cover">
        <div class="media align-items-end pt-5 row">
          <div class="profile mr-3">
            <img src="{{ asset('storage/images/companies/'.$company->name_slug.'.jpg') }}" alt="..." width="130"
              class="rounded mb-2">
          </div>
      ...
      {{-- <div class="py-4 px-4">
        <div class="d-flex align-items-center justify-content-between mb-3">
          <h5 class="mb-0">Recent jobs</h5><a href="{{ route('jobs.list', ['company' => $company->company_id]) }}"
            class="btn btn-link text-muted">View all</a>
        </div>
        <div class="row">
        </div>
      </div> --}}
